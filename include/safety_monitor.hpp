...
#include <string>
#include <vector>
#include <optional>  //missing header
...
std::optional<Obstacle> findNearestObstacle(const std::vector<Obstacle>& obstacles);  //the first error i faced during the building
